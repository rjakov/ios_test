...
- (void)addMainLabel {
    ...
    self.mainTextLabel.font = [UIFont boldSystemFontOfSize:15];
    self.mainTextLabel.textColor = [UIColor colorWithWhite:0.4 alpha:1.0];
...
- (void)addSubLabel {
    ...
    self.subTextLabel.textColor = [UIColor colorWithWhite:0.6 alpha:1.0];
